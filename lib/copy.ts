export const copy = {
  ...
  allClear: {
    ...
    meta: "{n} done today.",
    hint: "New work will show up here, already sorted.",
    team: "Help your team",
    updates: "See updates",
  },
  ...
  team: {
    ...
    needsYouEmptyHint: "This list fills when someone is stuck, unassigned, or asks for help.",
  ...
  itemDetail: {
    ...
    notFoundHint: "It may have been completed, reassigned, or the link is wrong.",
